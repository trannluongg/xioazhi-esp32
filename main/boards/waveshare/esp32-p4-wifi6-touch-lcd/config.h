...
#define TOUCH_SENSOR_GPIO GPIO_NUM_5
...
// Use ST7701 for 4.3 inch display (same as 4_3C)
...
#define DISPLAY_BACKLIGHT_PIN GPIO_NUM_26
#define DISPLAY_BACKLIGHT_OUTPUT_INVERT true
#define LCD_MIPI_DSI_LANE_BITRATE_MBPS (600)
#define LCD_DPI_CLOCK_FREQ_MHZ (40)
#define LCD_H_RES (480)
#define LCD_V_RES (800)
#define LCD_HSYNC_BACK_PORCH (42)
#define LCD_HSYNC_PULSE_WIDTH (12)
#define LCD_HSYNC_FRONT_PORCH (42)
#define LCD_VSYNC_BACK_PORCH (2)
#define LCD_VSYNC_PULSE_WIDTH (8)
#define LCD_VSYNC_FRONT_PORCH (60)
