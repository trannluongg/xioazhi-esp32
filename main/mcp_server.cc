...
void McpServer::AddCommonTools() {
    ...
    AddTool("self.stm32.send_command",
        "Send a command to the STM32 via I2C at address 0x20. Commands are 1-byte values that control motors and servos.",
        PropertyList({
            Property("command", kPropertyTypeInteger, 0, 255)
        }),
        [&board](const PropertyList& properties) -> ReturnValue {
